...
L.ArcedPolyline = L.Path.extend({
    ...
    drawSegment: function(point1, point2) {
        ...
        // BEZIER A AU MILIEU DES DEUX POINTS
        var distanceX = Math.abs((point1.x-point2.x)/2);

        //console.log(options);
        point1.x = point1.x+this.options.decalageX;
        point2.x = point2.x+this.options.decalageX;
        var parts = [ "M", point1.x, ",", point1.y, " C", point1.x + distanceX, ",", point1.y, " ", point2.x - distanceX, ",", point2.y , " ", point2.x, ",", point2.y ];

        // BEZIER DEPART DROIT
       /* var distanceX = Math.abs((point2.x-point1.x)/2);
        var parts = [ "M", point1.x, ",", point1.y, " C", point1.x, ",", point1.y, " ", point2.x - distanceX, ",", point2.y , " ", point2.x, ",", point2.y ];
*/

        // BEZIER DEPART HAUT
        /*var distanceX = Math.abs((point2.x-point1.x)/2);
        var parts = [ "M", point1.x, ",", point1.y, " C", point1.x, ",", point1.y-500, " ", point2.x - distanceX, ",", point2.y , " ", point2.x, ",", point2.y ];
*/
