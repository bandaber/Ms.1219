...
L.Draw.Polyline = L.Draw.Feature.extend({
	...
	options: {
		...
		icon: new L.DivIcon({
			iconSize: new L.Point(taillePoignees, taillePoignees),
...
L.Edit.Poly = L.Handler.extend({
	...
	_createMiddleMarker: function (marker1, marker2) {
		var latlng = this._getMiddleLatLng(marker1, marker2),
		   ...
		   // console.log(marker);
		   // marker.setIcon(poigneeInter);
		// marker._icon.clientHeight = 1;



		//marker.setIcon(poigneePetit);
		...
		onDragStart = function () {
			...
			//marker.setIcon(poigneeGrand);
			//marker.setOpacity(1);
			// marker.setIcon(poigneeExt);
